...
async def r34(ctx, *, tags):
    ...
    if ("cub" or "loli" or "shota" or "child" or "underage" or "shotacon") in tags.lower():
        await ctx.message.add_reaction(nsfw)
        ...
        xml_url = rule34.URLGen(tags + " -cub -loli -underage -shotacon -shota -child")
